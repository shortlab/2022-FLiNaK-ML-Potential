...
In order to proceed, several software packages need to be installed locally or on your cluster.  
These are: 
...
-	Have the N2P2 LAMMPS [interface installed](https://github.com/CompPhysVienna/n2p2)
